...
<table
	...
	<tr>
		...
		<th class="product-thumbnail"><?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_name_heading', __( 'Product name', 'yith-woocommerce-wishlist' ), $wishlist ) ); ?></th>
				...
				<tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
					...
					<?php if ( $show_last_column ) : ?>
						<td class="product-add-to-cart">
							...
							<div class="yith-ywraq-add-to-quote add-to-quote-<?php echo $item->get_product_id() ?>">
										<div class="yith-ywraq-add-button show" style="display:block" data-product_id="<?php echo $item->get_product_id() ?>">

								<a href="#" class="add-request-quote-button ywraq-link" data-product_id="<?php echo $item->get_product_id() ?>">
												Add to quote request	</a>
									</div>
									<div class="yith_ywraq_add_item_product-response-<?php echo $item->get_product_id() ?> yith_ywraq_add_item_product_message hide hide-when-removed" style="display:none" data-product_id="<?php echo $item->get_product_id() ?>">
									</div>
									<div class="yith_ywraq_add_item_browse-list-<?php echo $item->get_product_id() ?> yith_ywraq_add_item_browse_message  hide hide-when-removed" style="display:none" data-product_id="<?php echo $item->get_product_id() ?>">
										<a href="/request-quote/">Browse the list</a>
									</div>
