...
?>
	...
	<footer class="site-footer" role="contentinfo">
		...
		<div class="row">
			...
			<div class="col-md-5 footer_branding">
				<!-- <div class="row"> -->
			...
			<div class="col-md-5 footer_contact">
				<div class="row">
					<div class="col-md-4">
						...
						<img src="<?php echo get_template_directory_uri(); ?>/images/iso_9001.svg" alt="ISO 9001">
						<img src="<?php echo get_template_directory_uri(); ?>/images/iso_14001.svg" alt="ISO 14001">
					</div>
					<div class="col-md-4">
						<h5>Lets Talk</h5>
						<address class="">
					...
					<div class="col-md-4">
						<h5>Showroom</h5>
						<address class="">
							Design Hub Clerkenwell, <br>
							47 Gee Street, Clerkenwell, <br>
							London EC1V 3RS
						</address>
